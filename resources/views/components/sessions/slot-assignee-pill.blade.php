...
<button
    ...
    x-bind:class="assignedUserIsNotGoing ? 'border-rose-200 bg-rose-50/80 text-rose-800' : (assignedToCurrentUser ? 'border-sky-200 bg-sky-50/90 text-sky-800' : (slotIsOpen ? 'border-amber-200 bg-amber-50/80 text-amber-800' : 'border-emerald-200 bg-emerald-50/80 text-emerald-800'))"
